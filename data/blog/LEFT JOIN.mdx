...
The `join/5` function is used to perform a `left join` in Ecto. For more information about the `join/5` function, visit my <a href="/blog/JOIN">JOIN</a> page. Now let's explore the `:left` option in join.
