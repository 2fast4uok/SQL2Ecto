...
We are using the `countries` and `regions`table for this query. Refer <a href="/blog/Introduction">Introduction</a> to know about these tables and the database.  Just to show the whole records in the `HR.Country` in the table. 
