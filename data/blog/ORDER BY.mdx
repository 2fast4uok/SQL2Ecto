...
This query orders <a href="/blog/Introduction">employees</a> by `last_name` in ascending alphabetical order.
...
In Ecto, the [order_by/3](https://hexdocs.pm/ecto/Ecto.Query.html#order_by/3) function is used to alphabetically order records.
...
In both examples, `c` is the reference variable representing `HR.Employee`. For more on reference variables, see <a href="/blog/Aliases in Ecto">Aliases in Ecto</a>.
