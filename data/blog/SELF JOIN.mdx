...
date: '999-12-03'
draft: false
summary: The `SELF JOIN` command, used to join the same table with it's own table based on the queries.
layout: PostSimple
level: Intermediate
---
...
Let's use `locations` table for this query. Refer <a href="/blog/Introduction">Introduction</a> to know about this table and the database.

<img src="/static/images/Pastedimage20231108205230.png" width="1500" />
...
<img src="/static/images/Pastedimage20231108212727.png" width=" 1500" />
