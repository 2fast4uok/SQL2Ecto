...
Now let's apply this `or` condition for the <a href="/blog/Introduction">`employees`</a> table.
...
In [Ecto.Query](https://hexdocs.pm/ecto/Ecto.Query.html) you can fetch records that satisfy either one of the conditions by using the [or/2](https://hexdocs.pm/ecto/Ecto.Query.API.html#or/2) function.
...
The `c` in both conditions is a reference variable referring to the struct `HR.Employee`.  To know about the reference variable refer to <a href="/blog/Aliases in Ecto">reference variable</a>. 
