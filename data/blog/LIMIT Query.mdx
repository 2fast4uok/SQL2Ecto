...
date: '999-12-29'
draft: false
summary: The `limit` command is used to limit the number of records from being fetched.
layout: PostSimple
level: Basic
---
...
As explained in the <a href="/blog/Introduction">Introduction</a> part, the `employees` table has a total of 31 records.  Now let's set a limit to it.
...
<img src="/static/images/Pastedimage20231114101217.png" width="1500" />
...
`limit` is a key and its value is 2. Here c is the <a href="/blog/Aliases in Ecto">reference variable</a>. We are limiting the records to 2 using the `Keywords` format.